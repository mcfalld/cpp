//
// Created by Derrick on 24-Jul-2017.
//

#ifndef FINALASSIGNMENT_MANAGER_H

#define FINALASSIGNMENT_MANAGER_H
...
class manager
{
 public: std::map<std::string, std::unique_ptr<account>> accounts_map;

 public: std::unique_ptr<account> factory(std::string line)
  {
...
#endif //FINALASSIGNMENT_MANAGER_H
